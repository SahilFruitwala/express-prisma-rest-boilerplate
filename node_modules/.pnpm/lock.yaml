...
packages:
  ...
  /cloudinary/1.30.1:
    resolution: {integrity: sha512-Vri+R4VZXZUQWJ3vOoB5b0vjigxI/INRhzZF8E0A1O07bBNrwWAvodtDyumIk3RvEcgxzjvnqq83CPqoUyzEtA==}
    engines: {node: '>=0.6'}
    dependencies:
      cloudinary-core: 2.13.0_lodash@4.17.21
      core-js: 3.6.5
  ...
  /eslint-plugin-es/4.1.0_eslint@8.22.0:
